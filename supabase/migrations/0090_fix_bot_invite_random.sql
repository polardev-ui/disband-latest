-- 0090_fix_bot_invite_random.sql
-- gen_random_bytes lives in the extensions schema, which is not on the
-- function's search_path. Schema-qualify it (bot invites never worked).
